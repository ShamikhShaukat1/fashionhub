...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
    <div>
        ...
        <p class="text-xs text-stone-400 mt-1">
            Browse, edit, and manage your active product collection
        </p>
            ...
            <tbody class="divide-y divide-stone-800/50">
                ...
                <tr class="hover:bg-stone-800/30 transition">
                    <td class="p-4">
                        ...
                        <div class="w-12 h-12 rounded-xl bg-stone-950 border border-stone-800 flex items-center justify-center text-xs text-stone-600 font-bold">
                            N/A
                        </div>
                ...
                <tr>
                    <td colspan="7"
                        ...
                        <a href="{{ route('admin.products.create') }}" class="text-amber-400 hover:underline ml-1">
                            Create one now
                        </a>.
